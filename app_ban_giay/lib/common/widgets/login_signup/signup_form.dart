...
import 'package:app_ban_giay/features/authentication/screens/signup/verify_phone.dart';
  ...
  Widget build(BuildContext context) {
    return Form(child: Column(
      children: [
        ...
        //SignUp Btn
        SizedBox(width: double.infinity, child: ElevatedButton(onPressed: () => Get.to(() => const OTPVerify()), child: const Text(TTexts.signUp))),
